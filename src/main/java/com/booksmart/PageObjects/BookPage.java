...
public class BookPage {
	...
	final public static Logger logger = LogManager.getLogger(BookPage.class);

	public BookPage(String filename,String dataset) throws Exception {
		SeleniumLib.click(btnNewBook);
		Sync.waitforPageLoad(10);
		BookPage.logger.info("Navigated to New Book Page");
	...
	public void VerifyBookPageNavigated() throws Exception {
		
		SeleniumLib.getText(pageTitle);
	
	}
	
public void VerifyBookCreatedSuccesfully() throws Exception {
		
		String BookSuccessMsg=SeleniumLib.getText(pageTitle);
	BookPage.logger.info("Book Created: "+BookSuccessMsg);
	}
